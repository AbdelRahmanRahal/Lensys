// IGNORE THIS TILL LINE 1344, THIS IS THE HIGHLIGHT.JS SCRIPT 
// PASTED WITHIN THE EXTENSION FILE TO BYPASS THE CSP AND MANIFEST 
// CHECKS I DON'T KNOW ANY BETTER WAY TO DO IT AT MY CURRENT LEVEL,
// AS EVERYTHING ELSE HAS FAILED. SORRY.
 ...
 */
  var hljs=function(){"use strict";var e={exports:{}};function t(e){
	...
	;hljs.registerLanguage("ini",e)})();/*! `csharp` grammar compiled for Highlight.js 11.7.0 */
	...
	;hljs.registerLanguage("javascript",e)})();/*! `makefile` grammar compiled for Highlight.js 11.7.0 */
...
function editHighlightedText() {
	...
	if (selectedText) {
		...
		// Injecting the Highlight.js CSS theme as a style tag to bypass CSP
		const hljsStyle = document.createElement('style');
		hljsStyle.textContent = `pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}
		...
		newElement.appendChild(hljsStyle);
